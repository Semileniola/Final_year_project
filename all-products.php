...
<div class="inner-banner">
    <div class="container">
        <h2 class="inner-banner-title wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">All Products
        </h2>
                    ...
                    <div class="col-lg-12">
                        <div class="show-item-and-filte">
                            <p>Showing <strong class="show_count">
                                   <?php echo countall('id','products'); ?></strong> result</p>
...
<?php
	$result3 = mysqli_query($dbc,"SELECT * FROM `products` ORDER BY `date_created`");
...
$timecountdown = '       <div class="auction-timer">
    ...
    <div class="auction-img">
                    ...
                    <img alt="Acution image" src="uploads/products/features/'.$featureimage.'" onerror="this.onerror=null;this.src="uploads/placeholder.jpg";">
