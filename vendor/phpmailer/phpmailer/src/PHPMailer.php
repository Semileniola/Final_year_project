...
class PHPMailer
{
     ...
     *
     * @see    http://www.andrew.cmu.edu/user/ablue1/testing/mrbs/web/Mail/RFC822.php A more careful implementation
     *
    ...
    protected function lang($key)
    {
        ...
        if (array_key_exists($key, $this->language)) {
            if ('smtp_connect_failed' == $key) {
                ...
                return $this->language[$key] . ' https://hsoft.com.ng/support';
            }
